...
| `E48` | A media URL in the ancestor link's query IS the answer, so the page behind it is never fetched — that page's `og:image` is the site's share card | [`docs/RESOLVER.md`](docs/RESOLVER.md) |
